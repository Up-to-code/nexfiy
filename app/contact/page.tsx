...
export const metadata: Metadata = {
  title: 'Contact - Nexfiy',
  description: 'Get in touch with the developer behind Nexfiy.',
}
      ...
      <div className="container mx-auto px-6 md:px-12 max-w-3xl">
        ...
        <header className="mb-16">
          ...
          <p className="text-xl text-foreground/60 leading-relaxed font-medium tracking-tight">
            I'm an independent developer building tools to help people focus and live better. I'd love to hear from you.
          </p>
        </header>
        ...
        <div className="bg-secondary/30 rounded-[22px] overflow-hidden border border-border/50 mb-16">
          <a href="mailto:support@nexfiy.app" className="block group">
          ...
          <div className="block group cursor-pointer">
            <div className="flex items-center gap-4 p-5 sm:p-6 hover:bg-secondary/40 transition-colors">
              ...
              <div className="flex-1">
                ...
                <p className="text-[15px] text-foreground/50">
                  Share your thoughts to help improve the apps
                </p>
              </div>
            </div>
          </div>
